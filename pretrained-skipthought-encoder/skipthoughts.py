...
#-----------------------------------------------------------------------------#
path_to_models = "/Users/mjsilva/Documents/ironhack/git/final-project/pretrained-skipthought-encoder/data/"
path_to_tables = "/Users/mjsilva/Documents/ironhack/git/final-project/pretrained-skipthought-encoder/data/"
#-----------------------------------------------------------------------------#
...
def init_params_bi(options):
    """
    initialize all parameters needed for bidirectional encoder
    """
    params = OrderedDict()
